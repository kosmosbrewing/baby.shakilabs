...
// 안 된다 — 이 앱은 팔레트가 두 곳에 나뉘어 있고(index.html 인라인 critical CSS에
// 코어 팔레트, main.css에 --status-*), Tailwind가 참조 없는 블록을 통째로 지운
// 전례도 있다. 그래서 증거는 빌드 산출물이다: dist/index.html + dist/assets/*.css를
...
const SOURCE_FILES = ["index.html", "src/assets/css/main.css"];
