...
import { CHILD_ALLOWANCE_LINK, FINANCE_CROSS_LINKS, FIRST_MEETING_LINK, HOME_LINK } from "@/data/crossLinks";
...
const nextSteps = [HOME_LINK, CHILD_ALLOWANCE_LINK, FIRST_MEETING_LINK, ...FINANCE_CROSS_LINKS];
</script>
...
<template>
  ...
  <div class="container space-y-5 py-5">
    ...
    <FaqAccordionPanel :items="faqItems" :extra="PARENTAL_BENEFIT_GUIDE.faqs" />
